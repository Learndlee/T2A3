...
class Analysis:
    def __init__(self, o_price: int, c_price: int):
        ...
        #2 mandatory and 1 optional parameters
    ...
    def buy_or_sell(self):
        ...
        #control for if open price is greater and close price, the stock might be cheap - buy
...
#call buy instance of Analysis class, using arguments derived from lines 37 & 38
